...
- **El número del correo tiene que ser el que ve el destinatario en su pantalla.** 17-sep: el correo decía 86, la alarma de Mónica decía 16 (ventana de 90 días) y el real era 84 (duplicados). Antes de citar cifras del sistema, reproducir la pantalla del destinatario con su mismo rol; si difiere, arreglar el sistema y recalcular todo el documento.
- **Informe de madurez:** el molde (`/informe-madurez`) vive en `Documents/GSZ/Trikles/conciliacion-rodizzio/docs/informe_madurez_spec.md` y está pensado para el sistema de conciliación; aquí se adapta (la aguja es "hallazgos con respuesta"). Destinatarios habituales: Mónica + Evandro, Yonder en copia; sale desde `auditor.norte@grupotoda.com`.
