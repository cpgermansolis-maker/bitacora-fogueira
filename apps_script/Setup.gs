...
const SHEET_DEFINITIONS = [
  ...
  },
  {
    ...
    rows: [
      ...
      ['CKD04', 'M07', 'D', 'cajera',  'Cancelaciones del día justificadas y autorizadas (Gerente, Gerente de Plaza o capitán)', 'TRUE'],
      ...
      ['CKS08', 'M07', 'S', 'cajera',  'Descuentos/cancelaciones de la semana validados con autorización (Gerente, Gerente de Plaza o capitán)', 'TRUE'],
  ...
  },
  {
    ...
    rows: [
      ...
      ['CKBD14', 'B7', 'Cierre profundo',   'D', 'administracion', 'Cortesías capturadas con los 3 datos completos (autoriza/folio/motivo). Autoriza válido: Gerente, Gerente de Plaza o capitán', 'TRUE'],
      ...
      ['CKBD24', 'B7', 'Banderas rojas',    'D', 'administracion', 'Bandera 6: Todas las cortesías con autorización válida (Gerente, Gerente de Plaza o capitán)', 'TRUE'],
      ['CKBD25', 'B7', 'Banderas rojas',    'D', 'administracion', 'Bandera 7: Todas las cancelaciones con autorización documentada (Gerente, Gerente de Plaza o capitán)', 'TRUE'],
